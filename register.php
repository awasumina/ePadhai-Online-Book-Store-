   ...
   if(mysqli_num_rows($select_users) > 0){
      ...
      if($pass != $cpass){
         ...
         // else if($user_type == "admin"){
            // mysqli_query($conn, "INSERT INTO `admin`(name,lname, email, password, user_type) VALUES('$name','$lname', '$email', '$cpass', '$user_type')") or die('query failed');
            // $message[] = 'registered successfully!';
            // header('location:login.php');
            // }
      }
...
<div class="form-container">
   ...
   <img src="images/logow.png" alt="logo"  style="width:70px; height:auto;"><br><br>
      <h3>register now</h3>
